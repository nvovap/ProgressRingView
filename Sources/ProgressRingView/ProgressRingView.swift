...
//  SwiftUIProgressRing
//
//  Created by Vladimir on 19.11.2023.
//
...
struct ProgressBar_Library: LibraryContentProvider {
    ...
    var views: [LibraryItem] {
        ...
        LibraryItem(ProgressRingView(progress: .constant(1.0), thickness: 12.0, width: 130.0, gradient: Gradient(colors: [.darkYellow, .lightYellow])),
                    title: "Progress Ring",
                    category: .control
        )

        LibraryItem(ProgressRingView(progress: .constant(1.0), thickness: 30.0, width: 250.0, gradient: Gradient(colors: [.darkPurple, .lightYellow])), 
    ...
    @LibraryContentBuilder
    func modifiers(base: Rectangle) -> [LibraryItem] {
...
#Preview {
    ProgressRingView(progress: .constant(0.5)).previewDisplayName("ProgressRingView (50%)")
    //ProgressRingView(progress: .constant(0.9)).previewDisplayName("ProgressRingView (90%)")
}
